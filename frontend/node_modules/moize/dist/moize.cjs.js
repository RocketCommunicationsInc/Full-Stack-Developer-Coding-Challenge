...
var moize = function moize(fn, passedOptions) {
  ...
  var equalsIgnored = coalescedOptions.matchesArg,
      ...
      isShallowEqualIgnored = coalescedOptions.isShallowEqual,
      ...
      updateCacheForKey = coalescedOptions.updateCacheForKey,
      transformArgsIgnored = coalescedOptions.transformArgs,
      updateExpireIgnored = coalescedOptions.updateExpire,
      customOptions = _objectWithoutPropertiesLoose(coalescedOptions, ["matchesArg", "isDeepEqual", "isPromise", "isReact", "isSerialized", "isShallowEqual", "matchesKey", "maxAge", "maxArgs", "maxSize", "onCacheAdd", "onCacheChange", "onCacheHit", "onExpire", "profileName", "serializer", "updateCacheForKey", "transformArgs", "updateExpire"]);
  ...
  if (updateCacheForKey) {
    return createRefreshableMoized(moized);
  }
...
//# sourceMappingURL=moize.cjs.js.map
